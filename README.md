...
全新的小圣杯界面，涵盖绝大多数功能，适配 PC 与移动端，更流畅便捷的使用体验。
...
(async function () {
  ...
  script.src = 'https://cdn.jsdelivr.net/gh/koorinyaa/tinygrail-magic@latest/dist/tinygrail-magic.user.js'
  script.async = true
...
[点击安装](https://cdn.jsdelivr.net/gh/koorinyaa/tinygrail-magic@latest/dist/tinygrail-magic.user.js)
