  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="hidden group-data-[vaul-drawer-direction=bottom]/drawer-content:block">
          <div className="bg-gray-300/80 mx-auto mt-1 mb-2 h-1 w-10 shrink-0 rounded-full" />
        </div>
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
