...
export function StarTowerLog({
  ...
  const getLogMessage = (log: StarLogItem) => {
    switch (log.Type) {
      case 0:
        return (
          <span
            ...
            className="inline-flex flex-row items-center w-fit text-pink-500 hover:text-pink-600 w-fit whitespace-nowrap cursor-pointer overflow-hidden"
          >
            <div>星之力</div>
      ...
      case 2:
        return (
          <div
            ...
            className="inline-flex flex-row items-center text-pink-500 hover:text-pink-600 w-fit whitespace-nowrap cursor-pointer overflow-hidden"
          >
            <div>鲤鱼之眼</div>
            <div className="mx-1 truncate">
              @{decodeHTMLEntities(log.Nickname)}
      ...
      case 4:
        return (
          <div
            ...
            className="inline-flex flex-row items-center text-sky-500 hover:text-sky-600 w-fit whitespace-nowrap cursor-pointer overflow-hidden"
          >
            <div>精炼失败</div>
            <div className="mx-1 truncate">
              @{decodeHTMLEntities(log.Nickname)}
      ...
      default:
        return (
          <div className="inline-flex flex-row items-center text-sky-500 hover:text-sky-600 w-fit whitespace-nowrap overflow-hidden">
            <div>受到攻击</div>
